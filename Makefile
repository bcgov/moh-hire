...
open-db-tunnel:
	...
	ssh -i ssh-keypair ssm-user@$(BASTION_INSTANCE_ID) -L 5432:$(DB_HOST):5432 -o ProxyCommand="aws ssm start-session --target %h --document-name AWS-StartSSHSession --parameters 'portNumber=%p'"
