...
import { SubmissionDTO, PersonalInformationDTO, UpdateSubmissionDTO } from '@ehpr/common';
...
export class SubmissionService {
  ...
  async updateSubmission(confirmationId: string, payload: UpdateSubmissionDTO) {
    ...
    return this.submissionRepository.save({ ...record, ...payload });
  }
}
